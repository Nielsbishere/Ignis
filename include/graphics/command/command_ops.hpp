...
namespace ignis {
	...
	enum CommandOp : u32 {
		...
		CMD_FLUSH_BUFFER,
		CMD_FLUSH_IMAGE,
		//CMD_READBACK_BUFFER				//TODO:
		//CMD_READBACK_IMAGE				//TODO:
		...
		//Rare desktop extensions

		CMD_TRACE_RAYS_FT_2 = 
			(CMD_SUPPORT_DESKTOP_RARE << CMD_PROPERTY_SUPPORT_SHIFT) |
			(u32(Feature::RAY_TRACING) << CMD_PROPERTY_TECHNIQUE_SHIFT),

		CMD_BUILD_ACCELERATION_STRUCTURE_FT_2,
		CMD_COPY_ACCELERATION_STRUCTURE_FT_2,
		CMD_WRITE_ACCELERATION_STRUCTURE_PROPERTIES_FT_2,
